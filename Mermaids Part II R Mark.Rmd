...
price_predict <- predict(regression_male_year, newdata = df_new, se.fit = TRUE, interval="confidence")
...
smooth <-ggplot(grad_enroll, aes(x =Year, y = Total_Males, color="green") ) +
     geom_point() +
...
male_pr<-cor.test(grad_enroll$Year, grad_enroll$Total_Males)
##COrrelation between year and sex of enrollment
